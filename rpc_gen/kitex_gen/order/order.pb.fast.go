...
func (x *ListOrderReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.ListDeleted, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *UpdateOrderReq) fastWriteField1(buf []byte) (offset int) {
	if x.ChangedOrder == nil {
		return offset
	}
	offset += fastpb.WriteMessage(buf[offset:], 1, x.GetChangedOrder())
	return offset
}
...
func (x *ListOrderReq) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 2, x.GetListDeleted())
	return offset
}
...
func (x *UpdateOrderReq) sizeField1() (n int) {
	...
	n += fastpb.SizeMessage(1, x.GetChangedOrder())
	return n
}
...
func (x *ListOrderReq) sizeField2() (n int) {
	...
	n += fastpb.SizeInt32(2, x.GetListDeleted())
	return n
}
